...
<?php
    ...
    $twitter_account = apply_filters('theme_twitter_account', '@yG8elRmOJXxMFJo');
    if ($twitter_account) {
?>
...
function theme_ld_meta_tags() {
    ...
    $social_links = apply_filters('theme_social_links', array("https://facebook.com/profile.php?id=100028465565728","https://twitter.com/yG8elRmOJXxMFJo","https://www.instagram.com/apcy.yolo/"));
