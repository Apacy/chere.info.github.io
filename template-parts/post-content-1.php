...
if (!theme_the_post()) return;
 $post0 = $post;
 ?>
<?php $skip_min_height = false; ?><section class="u-clearfix u-section-1" id="sec-77a3">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <?php if ($post0 !== null) { ?><a href="<?php the_permalink(); ?>" class="u-blog-control u-link u-link-1"><?php _e(sprintf(__('Read more', 'site1'))); ?></a><?php } ?>
      </div>
